  ...
  return (
    <MagicGrid width={250} rowGap={40}>
      ...
      <Feature icon={FcHeatMap} title="Actively maintained">
        The commits speak for themselves. We're squashing bugs and releasing new features almost
        every week.
      </Feature>
    </MagicGrid>
  );
...
const Feature: ReactFC<{ icon: any; title: string }> = ({ icon: Icon, title, children }) => {
  return (
