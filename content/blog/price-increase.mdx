...
- With the new pricing, each seat owner can activate Sizzy on 3 computers at the same time
    ...
    - <b>Important</b>: Everyone who has an existing Sizzy subscription, regardless of the price, benefits from the new "3 activations per seat" logic ✨
...
This is also a big benefit for <b>existing subscriptions</b>: now you can activate Sizzy on 3 computers for every seat that you have on your subscription.
