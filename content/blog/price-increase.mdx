...
Up until now, every seat owner could activate the Sizzy license only on one device. That pricing seemed a bit unfair, so we changed it. We are happy to tell you, that now each seat owner can activate their license on three devices at the same time, regardless of the plan they're on.
